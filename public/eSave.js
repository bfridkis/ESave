    ...
    req.addEventListener("load", () => {
      if(req.status >= 200 && req.status < 400){
       ...
       let results = JSON.parse(req.responseText);
        ...
        let initBDSPriHeader = initPriBDSHeaderRow.appendChild(document.createElement("th"));
        initPriBDSHeader.textContent = "TOTAL BEFORE SHIPPING AND PROMOTIONS";
        initPriBDSHeader.style.textDecoration = "underline";
        ...
        initPriBDS.textContent = results[0]["INITIAL_PRICE"];
