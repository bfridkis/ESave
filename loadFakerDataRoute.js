              ...
              (err, row, fields) => {
                if (err) {
                  ...
                  if(req.body.numRets > 0){
                                                ...
                                                if (err) {
                                                  ...
                                                  if (req.body.numPromos > 0) {
                                                    ...
                                                    for(let j = 0; j < req.body.numPromos; j++){
                                                      ...
                                                      //randomRow is used to select a random retailer_product.
                                                      ...
                                                      //Remove retailer_product used from retailer_products array so it is
                                                      //not reused (which would generate a unique constraint violation).
                    ...
                    //Generates a random integer in range 0 - (max - 1) [inclusive]
                    ...
                    //Returns month as a number from 3-character month specifier.
