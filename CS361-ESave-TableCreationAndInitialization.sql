...
-- USER TABLE INSERTIONS --
 INSERT INTO user values (11, 'frid', '$2a$10$Fv7bn4WPHjqCZPNwcEkKDuxvoFnwFGHg5fqENc27NMSOrIy5Fuk6.', 'Benjamin', 'Fridkis', 'fridkisb@oregonstate.edu',
						 '1234 Lone Star, TX, 77042', '1234 Lone Star, TX, 77042', TRUE, TRUE, TRUE),
						 (21, 'emistock', '$2a$10$YvNjZTMuSv19hyWCHpL.Ve59JfCUEo3c3U21IC2KKNz7g5/vpK1he', 'Emily',
						 'Stockenbojer', 'stockene@oregonstate.edu', NULL, NULL, TRUE, TRUE, TRUE),
						 (31, 'zach_earl', '$2a$10$f6BEHCKMHxvZ7N6TBjbU.uGkNMStfn0s6OSPldEpXxYnNhfywS4yy', 'zach',
						 'earl', 'earlz@oregonstate.edu', NULL, NULL, TRUE, TRUE, TRUE),
						 (41, 'Nono_nora', '$2a$10$cjPAhVUSUzgoAQVn7qwXuO9RvVEwjq0qXjuyTPZ/tGXSmzmqtImC6', 'Nancy',
						 'Boespflug', 'nnc@gmail.com', NULL, NULL, TRUE, TRUE, TRUE);


-- RETAILER TABLE INSERTIONS --
INSERT INTO retailer values (11, 'Thrive Market', 'thrivemarket.com', NULL, 5.99),
							(21, 'Amazon', 'amazon.com', NULL, 4.99),
							(31, 'Target', 'target.com', NULL, 3.99),
							(41, 'Jet', 'jet.com', NULL, 6.99);

-- PRODUCT TABLE INSERTIONS --
INSERT INTO product values (11, 'Really Raw Honey', 720054111124, NULL);

-- PROMOTION TABLE INSERTIONS --
INSERT INTO promotion values (11, 20, 11,
...
INSERT INTO `order` values (11, 11, 11, 49.99, '2018-11-09 10:49:21', NULL, NULL);

-- REVIEW TABLE INSERTIONS --
INSERT INTO review values (11, 51, 'Excellent products! Loved the $20 off promotion!');

-- HISTORY TABLE INSERTIONS --
INSERT INTO history values (11, TRUE, '2018-11-09 10:49:21');

-- FAVORITES_ORDER TABLE INSERTIONS --
INSERT INTO favorites_order values (11, 11);

-- WISH_LIST TABLE INSERTIONS --
INSERT INTO wish_list values (11, 11);

-- MESSAGE TABLE INSERTIONS --
INSERT INTO message values (11, 'Why would I send a message to myself? Because there are no other users!
								(What user id should we use here [for sender] for messages generated by ESave?
								Perhaps 0?)', 11, 11, '2018-11-09 10:49:21', 11);

-- ORDER_PRODUCT TABLE INSERTIONS --
INSERT INTO order_product values (11, 11, 4);


-- ORDER_PROMOTION TABLE INSERTIONS --
INSERT INTO order_promotion values (11, 11);


-- RETAILER_PRODUCT TABLE INSERTIONS --
INSERT INTO retailer_product values (11, 11, 12.99,
...
INSERT INTO favorites_retailer values (11, 11);

-- RETAILER_RATING TABLE INSERTIONS --
INSERT INTO retailer_rating values (11, 11, 5);
